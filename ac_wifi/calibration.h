struct calibration {
  ...
  { 0x53049C, 0.723618, 1.872303, 0 },               //39 0A
  { 0x5303CD, 0.485106, 1.873963, 10 },              //40 10A(互感线圈)
  { 0xC84E2A, 0.473283, 1.857261, 10 },              //41 10A(互感线圈)
  { 0x3CE648, 0.464397, 1.857759, 5 },               //42 10A(互感线圈)
  { 0xEA51C7, 0.408595, 1.859175, 6 },               //43 6A, 2芯线
  { 0xF525C5, 0.723618, 1.881000, 10 },              //44 10A互感
  { 0x0DE401, 0.723618, 1.881000, 10 },              //45 10A
  //  {0x3CE648, 0.473283, 1.857261, 5}, // 5A(互感线圈)
};
